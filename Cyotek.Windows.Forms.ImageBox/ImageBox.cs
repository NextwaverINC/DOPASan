...
namespace Cyotek.Windows.Forms
{
    ...
    public class ImageBox : VirtualScrollableControl
    {
        ...
        public Image GetImage()
        {
            ...
            {
                GetImageDelegate d = new GetImageDelegate(GetImage);
        ...
        protected virtual void DrawSelection(PaintEventArgs e)
        {
            ...
            /*-- Edit Boyd --*/
                using (Brush brush = new SolidBrush(Color.FromArgb(this.SelectionColor.A, this.SelectionColor)))
                {
            ...
            {
                using (Pen pen = new Pen(Color.FromArgb(255, this.SelectionColor.R, this.SelectionColor.G, this.SelectionColor.B)))
                {
                    e.Graphics.DrawRectangle(pen, rect.X, rect.Y, rect.Width, rect.Height);
                }
            }
